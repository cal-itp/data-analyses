...
def condense_vp_to_linestring(analysis_date: str, dict_inputs: dict):
    """
    ...
    vp_condensed = (
        delayed(vp_transform.condense_point_geom_to_line)(
            vp,
    ...
    utils.geoparquet_gcs_export(vp_condensed, SEGMENT_GCS, f"{EXPORT_FILE}_{analysis_date}")
...
if __name__ == "__main__":
    ...
    for analysis_date in analysis_date_list:
        ...
        logger.info(f"{analysis_date}: condense vp for trip " f"{end - start}")
