...
subset_cols = ["agency", 'itp_id', 'route_id', "long_route_name", "District", "median_percent_with_coverage", "median_percent_no_coverage", "geometry_x"]
...
def merge_ntd(gdf):
    ...
    # run a "low data coverage route." Fill NA with the median of this figure.
...
def final_merge(routes_gdf):
    ...
    # Drop columns
    cols_to_drop = ['itp_id', 'route_id', '_merge','total_buses', 'calitp_itp_id']
    ...
    # Clean up % values
    m2["Percentage Of Trips W Low Cell Service"] = m2["Percentage Of Trips W Low Cell Service"].astype('int64')
