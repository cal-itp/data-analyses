...
METHODOLOGY = ('''
    ...
    Notes: Null values may be present. The "hqta_details" columns defines which part of the Public Resources Code definition the HQTA classification was based on. If "hqta_details" references a single operator, then "calitp_id_secondary" and "agency_secondary" are null. If "hqta_details" references the same operator, then "calitp_id_secondary" and "agency_secondary" are the same as "calitp_id_primary" and "agency_primary". 
    '''
)
