...
HQ_AREAS_URL = f"{ESRI_BASE_URL}CA_HQ_Transit_Areas/FeatureServer"
HQ_STOPS_URL = f"{ESRI_BASE_URL}CA_HQ_Transit_Stops/FeatureServer"
ROUTES_URL = f"{ESRI_BASE_URL}CA_Transit_Routes/FeatureServer"
STOPS_URL = f"{ESRI_BASE_URL}CA_Transit_Stops/FeatureServer"
SPEEDS_URL = f"{ESRI_BASE_URL}Speeds_By_Stop_Segments/FeatureServer"
ROUTE_SPEEDS_URL = f"{ESRI_BASE_URL}Speeds_By_Route_Time_of_Day/FeatureServer"