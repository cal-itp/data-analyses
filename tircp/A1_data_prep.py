...
def clean_project():
    ...
    df.loc[(df["grant_recipient"] == "Antelope Valley Transit Authority (AVTA)") & (df['award_year'] == 2020), "ppno"] = "CP059"
...
def clean_allocation(): 
    ...
    df.loc[(df["grant_recipient"] == "San Bernardino County Transportation Authority (SBCTA)")  & (df['award_year'] == 2016), "ppno"] = 1230
