...
trip_cols = ['trip_key', 'gtfs_dataset_key', 'activity_date',
...
# must includ pt_geom to return gdf
...
def get_vehicle_positions(ix_query):
    ...
    assert ix_query.activity_date.iloc[0] == dt.date(2023, 3, 15), 'hardcoded to 3/15 for now :)'
